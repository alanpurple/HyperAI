...
def static_or_dynamic_map_fn(fn, elems, fn_output_signature=None,
  ...
  if isinstance(elems, list):
    ...
    for elem_shape in elem_shapes:
      if (not elem_shape or not elem_shape[0]
        ...
        return tf.map_fn(fn, elems, parallel_iterations=parallel_iterations, back_prop=back_prop,fn_output_signature=fn_output_signature)
